...
def parse_args():
    ...
    parser.add_argument('--Total_evolutionary_algebra', type=int, default=10,
    ...
    parser.add_argument('--my_max_epoch_G', type=int, default=120, help='numbers of mute_max_num')
    parser.add_argument('--max_model_size', type=float, default=15, help='max model size')
